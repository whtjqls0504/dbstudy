...
-- 5로 시작하는 문장자체에서 LIKE~ % 에 대한 답이 있었다. 
...
HAVING COUNT(B.BUY_NO) >= 2;
 ...
 -- 사용자를 숙별할 수 있는 중복이 되지 않는 칼럼을 같이 작성해줘야한다.
